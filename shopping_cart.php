...
class ShoppingCart extends DBController
{
    ...
    {
        $query = "SELECT all_products.*,tbl_cart.id as cart_id,tbl_cart.quantity, all_brands.br_name FROM all_products, tbl_cart, all_brands WHERE all_products.pr_id =tbl_cart.product_id AND all_products.br_id =all_brands.br_id AND tbl_cart.member_id = ?";
    ...
    {
        $query = "SELECT * FROM all_products WHERE code=?";
