                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php
                                        $count = mysqli_fetch_array(mysqli_query($connection, "SELECT COUNT(*) FROM all_brands"));
                                        echo $count[0];
                                        ?>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php
                                        $count = mysqli_fetch_array(mysqli_query($connection, "SELECT COUNT(*) FROM all_products"));
                                        echo $count[0];
                                        ?>
                                    </div>
                                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                <?php
                                                $count = mysqli_fetch_array(mysqli_query($connection, "SELECT COUNT(*) FROM stores"));
                                                echo $count[0];
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <div class="col mr-2">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                <?php
                                                $count = mysqli_fetch_array(mysqli_query($connection, "SELECT COUNT(*) FROM feedback"));
                                                echo $count[0];
                                                ?>
                                            </div>
                                        </div>
